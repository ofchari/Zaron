...
class GlStiffnner extends StatefulWidget {
  const GlStiffnner({super.key});

  @override
  State<GlStiffnner> createState() => _GlStiffnnerState();
}

class _GlStiffnnerState extends State<GlStiffnner> {
  late double height;
  late double width;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Subhead(text: "GL Stiffner ", weight: FontWeight.w500, color: Colors.black),
        centerTitle: true,
      ),
      body: Padding(
