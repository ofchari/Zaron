...
class GIGlutterImageUpload extends StatefulWidget {
  final String productId;

  const GIGlutterImageUpload({required this.productId, super.key});

  @override
  State<GIGlutterImageUpload> createState() => _GIGlutterImageUploadState();
}

class _GIGlutterImageUploadState extends State<GIGlutterImageUpload> {
  File? _selectedImage;
