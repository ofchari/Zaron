...
import 'package:zaron/view/screens/camera_upload/gi_glutter_uploads/gi_glutter_image_upload.dart';
import 'package:zaron/view/universal_api/api_key.dart';
import 'package:zaron/view/widgets/subhead.dart';

class GIGlutterAttachment extends StatefulWidget {
  final String productId;
  final String mainProductId;

  const GIGlutterAttachment({
    super.key,
  ...
  @override
  State<GIGlutterAttachment> createState() => _GIGlutterAttachmentState();
}

class _GIGlutterAttachmentState extends State<GIGlutterAttachment> {
                  ...
                  child: ElevatedButton.icon(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => GIGlutterImageUpload(
