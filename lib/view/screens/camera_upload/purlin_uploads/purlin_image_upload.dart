...
class PurlinImageUpload extends StatefulWidget {
  final String productId;

  const PurlinImageUpload({required this.productId, super.key});

  @override
  State<PurlinImageUpload> createState() => _PurlinImageUploadState();
}

class _PurlinImageUploadState extends State<PurlinImageUpload> {
  File? _selectedImage;
