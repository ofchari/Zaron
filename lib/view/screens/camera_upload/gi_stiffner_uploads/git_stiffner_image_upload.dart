...
class GIStiffnerImageUpload extends StatefulWidget {
  final String productId;

  const GIStiffnerImageUpload({required this.productId, super.key});

  @override
  State<GIStiffnerImageUpload> createState() => _GIStiffnerImageUploadState();
}

class _GIStiffnerImageUploadState extends State<GIStiffnerImageUpload> {
  File? _selectedImage;
