...
import 'git_stiffner_image_upload.dart';

class GIStiffnerAttachment extends StatefulWidget {
  final String productId;
  final String mainProductId;

  const GIStiffnerAttachment({
    super.key,
  ...
  @override
  State<GIStiffnerAttachment> createState() => _GIStiffnerAttachmentState();
}

class _GIStiffnerAttachmentState extends State<GIStiffnerAttachment> {
                  ...
                  child: ElevatedButton.icon(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => GIStiffnerImageUpload(
