...
import 'package:zaron/view/screens/camera_upload/roll_sheets_uploads/roll_sheet_image_upload.dart';
import 'package:zaron/view/universal_api/api&key.dart';
import 'package:zaron/view/widgets/subhead.dart';

class RollAttachment extends StatefulWidget {
  final String productId;
  final String mainProductId;

  const RollAttachment({
    super.key,
  ...
  @override
  State<RollAttachment> createState() => _RollAttachmentState();
}

class _RollAttachmentState extends State<RollAttachment> {
                  ...
                  child: ElevatedButton.icon(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => RollImageUpload(
