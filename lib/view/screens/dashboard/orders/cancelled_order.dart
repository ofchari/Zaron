...
class CancelledOrder extends StatefulWidget {
  ...
  @override
  State<CancelledOrder> createState() => _CancelledOrderPageState();
}

class _CancelledOrderPageState extends State<CancelledOrder> {
...
// If all methods fail
  ...
  Future<void> fetchEnquiryData() async {
    ...
    final String url = '$apiUrl/cancelledOrder/${UserSession().userId}';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonData is Map<String, dynamic> &&
            jsonData.containsKey("cancelled_order")) {
          final List<dynamic> enquiryList = jsonData["cancelled_order"];
