        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Gap(10),
              // Table
              // Replace the DataTable section with this card-based UI
              // Keep everything else in your code the same

              // Replace this part in your build method:
              // From: isLoading ? Expanded(child: Center(child: CircularProgressIndicator()))
              // To the end of the current DataTable implementation
