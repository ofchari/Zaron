...
import '../../controller/tilesheet_get_controller.dart';

class TileSheetPage extends GetView<TileSheetController> {
  ...
  Widget build(BuildContext context) {
    if (!Get.isRegistered<TileSheetController>()) {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Obx(() => buildAnimatedDropdown(
                                  ...
                                  enabled: controller.colorList.isNotEmpty,
                                  label: "Color",
