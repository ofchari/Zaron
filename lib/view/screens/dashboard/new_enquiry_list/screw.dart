...
class Screw extends GetView<ScrewController> {
  ...
  Widget build(BuildContext context) {
    if (!Get.isRegistered<ScrewController>()) {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Obx(() => buildAnimatedDropdown(
                                  ...
                                  controller.selectedScrew.value.isNotEmpty
                                      ? controller.selectedScrew.value
                                      : null,
                                  (value) {
                                    controller.selectedScrew.value =
                            ...
                            Obx(() => buildAnimatedDropdown(
                                  controller.threadList,
                                  controller.selectedThread.value.isNotEmpty
                                      ? controller.selectedThread.value
                                      : null,
                                  (value) {
                                    controller.selectedThread.value =
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  if (controller.selectedBrand.value.isEmpty ||
                                          controller.selectedScrew.value.isEmpty
                                      // ||
                                      // controller.selectedThread.value.isEmpty
                                      ) {
                                    Get.snackbar(
                                      "Error",
